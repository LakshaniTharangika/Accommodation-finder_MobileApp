...
<div class="flex min-h-screen flex-col">
    <nav class="border-gray-200 bg-white dark:bg-gray-900">
        ...
        >
            ...
            <div
                class="hidden w-full flex-row items-center gap-8 md:flex md:w-auto"
                id="navbar-default"
            >
                <ul
    ...
    <footer class="float-end w-full pt-10">
        <div class="mx-auto max-w-screen-xl px-4 text-gray-600 md:px-8">
            <div
                class="mt-10 items-center justify-between border-t py-10 sm:flex"
            >
                <p>© 2024 Hostel Management. All rights reserved.</p>
                <ul
                    class="mt-6 flex flex-wrap items-center gap-4 sm:mt-0 sm:text-sm"
                >
                    {#each footerNavs as item (item.name)}
                        <li
                            class="text-gray-800 duration-150 hover:text-gray-500"
                        >
